          ...
          <div className="filter-card">
            ...
            <div className="filter-content">
              <div className="input-group">
                ...
                />
                <button className="btn-search" onClick={refreshPedidos}>
                  <span className="btn-icon">🔍</span>Buscar
                </button>
                <button 
                  className="btn-clear" 
          ...
          <div className="filter-card">
            ...
            {periodoFilter && (
              <div className="filter-info">
                <span className="info-label">Mostrando desde:</span> 
                <span className="info-value">{formatDatePeru(getDateFromPeriod(periodoFilter))}</span>
              </div>
            )}
          </div>
        </div>
